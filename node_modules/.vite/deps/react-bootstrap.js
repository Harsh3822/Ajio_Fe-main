...
function forEach(children, func) {
  ...
  React38.Children.forEach(children, (child) => {
    if (React38.isValidElement(child)) func(child, index++);
  });
}
...
var Container = React41.forwardRef(({
  bsPrefix,
  fluid = false,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
...
var DropdownButton = React42.forwardRef(({
  ...
  ref,
  ...props,
  children: [(0, import_jsx_runtime39.jsx)(DropdownToggle_default, {
    id,
    href,
    size: size2,
    variant,
    ...
    children: title
  }), (0, import_jsx_runtime39.jsx)(DropdownMenu_default, {
    role: menuRole,
...
var Feedback = React47.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    as: Component2 = "div",
    className,
...
var FormContext = React48.createContext({});
var FormContext_default = FormContext;

// node_modules/react-bootstrap/esm/FormCheckInput.js
var import_jsx_runtime46 = __toESM(require_jsx_runtime());
var FormCheckInput = React49.forwardRef(({
  id,
  bsPrefix,
  className,
  type = "checkbox",
...
var FormCheckLabel = React50.forwardRef(({
  bsPrefix,
  className,
  htmlFor,
  ...props
...
var FormCheck = React51.forwardRef(({
  id,
  bsPrefix,
  bsSwitchPrefix,
  inline = false,
  ...
  const innerFormContext = (0, import_react19.useMemo)(() => ({
...
var FormFloating = React53.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Switch = React59.forwardRef((props, ref) => (0, import_jsx_runtime58.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react29.useRef)(inProp);
  ...
  const child = (0, import_react29.cloneElement)(children, {
    ref: combinedRef
  });
...
function getReactVersion() {
  const parts = React69.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
function useRTGTransitionProps(_ref) {
  ...
  return Object.assign({}, props, {
    ...
    ) : (0, import_react30.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React70.forwardRef((_ref, ref) => {
  let {
...
function useTransition({
  ...
  const isInitialRef = (0, import_react31.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react31.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react31.cloneElement)(children, {
    ref: combinedRef
  });
}
...
var Modal = (0, import_react32.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime70.jsx)(import_jsx_runtime71.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime72.jsxs)(import_jsx_runtime71.Fragment, {
...
var ModalBody = React73.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalFooter = React76.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var AbstractModalHeader = React77.forwardRef(({
  ...
  const context4 = (0, import_react33.useContext)(ModalContext_default);
...
var ModalTitle = React79.forwardRef(({
  className,
  bsPrefix,
...
var Modal2 = React80.forwardRef(({
  ...
  const renderBackdrop = (0, import_react34.useCallback)((backdropProps) => (0, import_jsx_runtime80.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime80.jsx)("div", {
    ...
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime80.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime80.jsx)(ModalContext_default.Provider, {
    value: modalContext,
...
var NavbarCollapse = React85.forwardRef(({
  ...
  const context4 = (0, import_react36.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime85.jsx)(Collapse_default, {
...
var NavbarToggle = React86.forwardRef(({
  ...
  return (0, import_jsx_runtime86.jsx)(Component2, {
    ...
    children: children || (0, import_jsx_runtime86.jsx)("span", {
...
var OffcanvasToggling = React88.forwardRef(({
  ...
  return (0, import_jsx_runtime88.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
    ...
    children: (status, innerProps) => React88.cloneElement(children, {
      ...innerProps,
      className: (0, import_classnames67.default)(className, children.props.className, (status === ENTERING || status === EXITING) && `${bsPrefix}-toggling`, transitionStyles[status])
    })
  });
});
...
function DialogTransition2(props) {
  return (0, import_jsx_runtime91.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React91.forwardRef(({
  ...
  const renderBackdrop = (0, import_react40.useCallback)((backdropProps) => (0, import_jsx_runtime91.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames70.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime91.jsx)("div", {
    ...dialogProps,
    ...props,
    className: (0, import_classnames70.default)(className, responsive ? `${bsPrefix}-${responsive}` : bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
  return (0, import_jsx_runtime93.jsxs)(import_jsx_runtime92.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime91.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
var NavbarOffcanvas = React92.forwardRef((props, ref) => {
  const context4 = (0, import_react41.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime94.jsx)(Offcanvas_default, {
    ref,
...
var Navbar = React94.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime96.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
    children: (0, import_jsx_runtime96.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime96.jsx)(Component2, {
        ref,
        ...controlledProps,
        className: (0, import_classnames72.default)(className, bsPrefix, expand && expandClass, variant && `${bsPrefix}-${variant}`, bg && `bg-${bg}`, sticky && `sticky-${sticky}`, fixed && `fixed-${fixed}`)
      })
    })
  });
});
...
var NavDropdown = React95.forwardRef(({
  ...
  return (0, import_jsx_runtime98.jsxs)(Dropdown_default, {
    ref,
    ...props,
    className: (0, import_classnames73.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime97.jsx)(Dropdown_default.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime97.jsx)(Dropdown_default.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
var Overlay = React96.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react44.useState)(!props.show);
...
var Popover = React100.forwardRef(({
  ...
  return (0, import_jsx_runtime102.jsxs)("div", {
    ...
    className: (0, import_classnames76.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
    children: [(0, import_jsx_runtime101.jsx)("div", {
      className: "popover-arrow",
      ...arrowProps
    }), body ? (0, import_jsx_runtime101.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
var Tooltip = React101.forwardRef(({
  ...
  return (0, import_jsx_runtime104.jsxs)("div", {
    ...
    role: "tooltip",
    "x-placement": primaryPlacement,
    className: (0, import_classnames77.default)(className, bsPrefix, `bs-tooltip-${bsDirection}`),
    ...props,
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react45.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React102.forwardRef(({
  ...
  const popperRef = (0, import_react46.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react46.useState)(null);
  ...
  return (0, import_jsx_runtime105.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return React102.cloneElement(overlay, {
        ...
        popper,
        hasDoneInitialMeasure,
        className: (0, import_classnames78.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
var OverlayTrigger = ({
  ...
  const triggerNodeRef = (0, import_react47.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout2 = useTimeout();
  const hoverStateRef = (0, import_react47.useRef)("");
  ...
  const handleShow = (0, import_react47.useCallback)(() => {
    timeout2.clear();
  ...
  const handleFocus = (0, import_react47.useCallback)((...args) => {
    handleShow();
    onFocus == null || onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react47.useCallback)((...args) => {
    handleHide();
    onBlur == null || onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react47.useCallback)((...args) => {
    setShow(!show);
    onClick == null || onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react47.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react47.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime108.jsxs)(import_jsx_runtime107.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react47.cloneElement)(children, triggerProps), (0, import_jsx_runtime106.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React104.forwardRef(({
  ...
  return (0, import_jsx_runtime109.jsx)("li", {
    ref,
    style: style2,
    className: (0, import_classnames79.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime110.jsxs)(Component2, {
      className: (0, import_classnames79.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime109.jsx)("span", {
        className: "visually-hidden",
...
function createButton(name, defaultValue, label = name) {
  const Button = React104.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime110.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React105.forwardRef(({
  ...
  return (0, import_jsx_runtime111.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames80.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames81.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React106.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime112.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime114.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames82.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
    ...
    "aria-valuemin": min,
    "aria-valuemax": max,
    children: visuallyHidden ? (0, import_jsx_runtime114.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
...
var ProgressBar = React108.forwardRef(({
  ...
  return (0, import_jsx_runtime114.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react48.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min,
      now,
...
var Ratio = React109.forwardRef(({
  ...
  return (0, import_jsx_runtime115.jsx)("div", {
    ...
    className: (0, import_classnames83.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
...
var Row = React110.forwardRef(({
  ...
  return (0, import_jsx_runtime116.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames84.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var Spinner = React111.forwardRef(({
  ...
  return (0, import_jsx_runtime117.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames85.default)(className, bsSpinnerPrefix, size2 && `${bsSpinnerPrefix}-${size2}`, variant && `text-${variant}`)
  });
});
...
var SplitButton = React112.forwardRef(({
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime119.jsxs)(Dropdown_default, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime118.jsx)(Button_default2, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime118.jsx)(Dropdown_default.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
  ...
  }), (0, import_jsx_runtime118.jsx)(Dropdown_default.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip,
...
var Stack = React113.forwardRef(({
  ...
  return (0, import_jsx_runtime120.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames86.default)(className, bsPrefix, ...createUtilityClassName({
      gap
...
function useTabPanel(_ref) {
  ...
  const context4 = (0, import_react49.useContext)(TabContext_default);
    ...
    return (0, import_jsx_runtime121.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime121.jsx)(SelectableContext_default.Provider, {
        ...
        children: (0, import_jsx_runtime121.jsx)(Transition2, {
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime121.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react50.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react50.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime123.jsx)(Tabs_default, {
  ...props,
...
var TabPane = React118.forwardRef(({
  ...
  return (0, import_jsx_runtime125.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime125.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime125.jsx)(Transition2, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
        ...
        mountOnEnter,
        unmountOnExit,
        children: (0, import_jsx_runtime125.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames88.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime127.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime127.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime128.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime127.jsx)(Nav_default2, {
      id,
      ...controlledProps,
      role: "tablist",
      as: "ul",
    ...
    }), (0, import_jsx_runtime127.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime127.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React121.forwardRef((props, ref) => (0, import_jsx_runtime129.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React122.createContext({
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  onClose() {
  }
});
...
var ToastHeader = React123.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context4 = (0, import_react51.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
  ...
  return (0, import_jsx_runtime131.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames90.default)(bsPrefix, className),
    children: [children, closeButton && (0, import_jsx_runtime130.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var ToastBody = React124.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Toast = React125.forwardRef(({
  ...
  const delayRef = (0, import_react52.useRef)(delay);
  const onCloseRef = (0, import_react52.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react52.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react52.useMemo)(() => ({
    onClose
  }), [onClose]);
  const hasAnimation = !!(Transition2 && animation);
  const toast = (0, import_jsx_runtime133.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames92.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
  return (0, import_jsx_runtime133.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition2 ? (0, import_jsx_runtime133.jsx)(Transition2, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToastContainer = React126.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
  ...
  return (0, import_jsx_runtime134.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames93.default)(bsPrefix, position && positionClasses[position], containerPosition && `position-${containerPosition}`, className)
  });
});
...
var noop4 = () => void 0;
var ToggleButton = React127.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
  ...
  return (0, import_jsx_runtime137.jsxs)(import_jsx_runtime136.Fragment, {
    children: [(0, import_jsx_runtime135.jsx)("input", {
      className: bsPrefix,
      name,
      type,
      value,
      ...
      id
    }), (0, import_jsx_runtime135.jsx)(Button_default2, {
      ...props,
      ref,
...
var ToggleButtonGroup = React128.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
  ...
  return (0, import_jsx_runtime138.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
