...
function CartPage() {
  ...
  useEffect(() => {
    axios.get("https://ajio-be-main-1.onrender.com/cart")
      .then(res => setCartItems(res.data))
      .catch(err => console.log("Error loading cart:", err));
  }, []);

  const handleDelete = (id) => {
    axios.delete(`https://ajio-be-main-1.onrender.com/cart/${id}`)
      .then(() => {
  ...
  const updateQty = (item, type) => {
    ...
    axios.put(`https://ajio-be-main-1.onrender.com/cart/${item.id}`, updated)
      .then(() => {
